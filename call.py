print("""
   ...
   []                                            []
   []             #Author : Xc0mByt3             []
   []        #Email  : xcombyte@gmail.com        []
   []    #Github : https://github.com/Xc0mByt3   []
   []                                            []
   []===============[] Xc0mByt3 []===============[]
    ...
    1.Masukkan command $nano phone.txt !
    2.Masukkan Daftar Nomor Target !
    3.save !

Lanjut Kalian Tinggal Eksekusi !

Command Eksekusi: $python2 call.py phone.txt
...
try:
    ...
    print("Execution: $python2 call.py phone.txt".format(sys.argv[0]))
    sys.exit()
